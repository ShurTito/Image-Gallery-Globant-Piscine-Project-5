...
function updateUIForLoggedInUser() {
    document.getElementById('loginBtn').style.display = 'none'; // Oculta el botón de login
    document.getElementById('logoutBtn').style.display = 'block'; // Asegúrate de mostrar el botón de logout
}
